                ...
                return function () {
                    ...
                    var size = el.getAttribute('data-size').split('x'),
                        svgData = [
                            ...
                            '<style type="text/css"><![CDATA[ * {font-family: Tahoma, Helvetica;} .title{font-size: 15px; text-decoration: underline; fill: blue;} .text{font-size: 13px;} .url{font-size: 12px; fill:green;}]]></style>'
                        ],
                        x = 4;
